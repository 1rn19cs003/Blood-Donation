        ...
        registerButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(bloodGroup.equals("Select your blood group")){
                    Toast.makeText(DonarRegistrationActivity.this,"Select Blood Group",Toast.LENGTH_SHORT);
                    return;
                }
                else{
                    loader.setMessage("Registering you..Please wait a while.");
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            else
                            {
                                ...
                                userInfo.put("search","donar"+bloodGroup);

                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@  NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(DonarRegistrationActivity.this,"Data set Succsessfully ",Toast.LENGTH_SHORT).show();
                                        }else {
                                               ...
                                               result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                   ...
                                                   public void onSuccess(Uri uri) {
                                                       ...
                                                       userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                           ...
                                                           public void onComplete(@NonNull Task task) {
                                                               if(task.isSuccessful()){
                                                                    Toast.makeText(DonarRegistrationActivity.this,"Image url added successfully",Toast.LENGTH_SHORT).show();
                                                               }else{
                                                                   Toast.makeText(DonarRegistrationActivity.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
                                                               }
                                                           }
