...
//                String type=snapshot.child("type").getValue().toString();
                String typ = (String)snapshot.child("type").getValue();
//                Boolean temp=true;
//                temp=typ.equals("donar");

                System.out.println(snapshot.child("type").getValue());
//                System.out.println(snapshot.child("type").getValue().toString());
//                readRecipients();
                if(typ!=null && typ.equals("donar")){
                    readRecipients();
                }else{
                    readDonars();
                }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if(snapshot.hasChild("profilepictureurl")) {
                        ...
                        Glide.with(getApplication()).load(imageUrl).into(nav_profile_image);
                    }else{
    ...
    private void readRecipients() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                progressBar.setVisibility(View.GONE);
                if(userList.isEmpty()){
                    Toast.makeText(MainActivity.this,"No Hospitals",Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
