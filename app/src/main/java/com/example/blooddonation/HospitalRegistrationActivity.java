    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenet=new Intent(HospitalRegistrationActivity.this,LoginActivity.class);
        ...
        registerButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(bloodGroup.equals("Select your blood group")){
                    Toast.makeText(HospitalRegistrationActivity.this,"Select Blood Group",Toast.LENGTH_SHORT);
                    return;
                }
                else{
                    loader.setMessage("Registering you..Please wait for a while.");
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            else
                            {
                                ...
                                userInfo.put("search","hospital"+bloodGroup);

                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(HospitalRegistrationActivity.this,"Data set Succsessfully ",Toast.LENGTH_SHORT).show();
                                        }else {
                                ...
                                if(resultUri!=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(HospitalRegistrationActivity.this,"Image Upload Failed",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(HospitalRegistrationActivity.this,"Image url added successfully",Toast.LENGTH_SHORT).show();
                                                                }else{
                                                                    Toast.makeText(HospitalRegistrationActivity.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
